...
const CreateEvent = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (!validTypes.includes(file.type)) {
      setErrors(prev => ({
        ...prev,
        image: 'Please upload a valid image (JPEG, PNG, WebP, GIF)'
      }))
      return
    }
  ...
  const validateForm = () => {
    ...
    if (
      ...
      !/^[\+]?[1-9][\d\s\-\(\)]{8,}$/.test(formData.contactInfo.phone)
    ) {
  ...
  const inputError =
    'border-red-300 focus:border-red-500 focus:ring-red-200/80'

  const labelClass =
    'mb-2 block text-sm font-semibold tracking-wide text-slate-800'
            ...
            <div className="relative flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm text-slate-600 md:text-base">
                  Fill in the details, add a cover, and publish a polished event
                  page for students.
                </p>
              </div>
...
<section className={`${sectionClass}`}>
  ...
  <div className="relative mb-4 flex flex-wrap items-center justify-between gap-3">
    <div>
      ...
      <p className="mt-1 text-xs sm:text-sm text-slate-600">
        A nice banner instantly makes your event look attractive.
      </p>
    </div>

    <span className="rounded-full bg-slate-900 text-xs font-semibold text-white px-3 py-1 shadow-sm">
      Optional
    </span>
  </div>
  ...
  {!imagePreview ? (
    ...
    <label
      htmlFor="image"
      className="block relative overflow-hidden rounded-2xl border border-dashed border-slate-300 bg-slate-50/80 p-8 text-center cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:border-sky-400 hover:bg-white hover:shadow-[0_20px_55px_rgba(56,189,248,0.25)] sm:p-10"
    >
    ...
    <div className="rounded-2xl border border-slate-200 bg-white/90 p-3 shadow-lg">
      ...
      <div className="relative overflow-hidden rounded-xl">
        ...
        <button
          ...
          onClick={removeImage}
          disabled={isSubmitting}
          className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-red-500 text-white shadow-md hover:bg-red-600"
        >
      ...
      {errors.image}
            ...
            <section className={sectionClass}>
              <div className="relative mb-4">
                ...
                <p className="mt-1 text-xs sm:text-sm text-slate-600">
                  Core details that appear at the top of your event page.
                </p>
              </div>
            ...
            <section className={sectionClass}>
              <div className="relative mb-4">
                ...
                <p className="mt-1 text-xs sm:text-sm text-slate-600">
                  Select when and where the event will take place.
                </p>
              </div>
            ...
            <section className={sectionClass}>
              <div className="relative mb-4">
                ...
                <p className="mt-1 text-xs sm:text-sm text-slate-600">
                  Set the last date students can register.
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`${inputBase} ${
                    errors.registrationDeadline ? inputError : ''
                  }`}
            ...
            <section className={sectionClass}>
              <div className="relative mb-4">
                ...
                <p className="mt-1 text-xs sm:text-sm text-slate-600">
                  Add extra instructions and tags to help discovery.
                </p>
              </div>
            ...
            <section className={sectionClass}>
              <div className="relative mb-4 flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs sm:text-sm text-slate-600">
                    Let students reach out if they have questions.
                  </p>
                </div>
                <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700">
                  Optional
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className={`${inputBase} ${
                      errors['contactInfo.email'] ? inputError : ''
                    }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`${inputBase} ${
                      errors['contactInfo.phone'] ? inputError : ''
                    }`}
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-slate-200 pt-6 sm:flex-row sm:justify-end">
              <button
                ...
                className="inline-flex items-center justify-center rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-[0_10px_26px_rgba(15,23,42,0.10)] transition-all duration-300 hover:-translate-y-0.5 hover:border-slate-400 hover:bg-slate-50"
                disabled={isSubmitting}
              >
                Cancel
              </button>
