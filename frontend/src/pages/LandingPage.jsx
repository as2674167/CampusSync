          ...
          <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[#0a0a0a]/90 backdrop-blur-md shadow-[0_30px_120px_rgba(0,0,0,0.55)]">
            ...
            <div className="grid items-center gap-10 px-6 py-10 sm:px-10 sm:py-12 lg:grid-cols-2 lg:px-14 lg:py-16">
              <div className="max-w-xl">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[0.95] tracking-tight text-white transition duration-300 hover:text-cyan-100">
                  CampusSync
                  <span className="mt-3 block text-lg sm:text-xl lg:text-2xl font-medium text-cyan-300 transition duration-300 hover:text-cyan-200">
                    Your smart event platform for college life
                  </span>
                </h1>

                <p className="mt-6 max-w-md text-sm sm:text-base leading-7 text-white/60 transition duration-300 hover:text-white/80">
                ...
                <div className="mt-10 flex flex-wrap gap-6">
                  {[
                    ...
                    >
                      <p className="text-2xl font-bold text-white transition duration-300 hover:text-cyan-300">
                        {item.value}
                      </p>
                ...
                <div className="mt-8 flex flex-wrap gap-4 text-xs text-slate-300">
                  {['Role-based access', 'Faster approvals', 'Better tracking'].map(
                    (item, index) => (
                      <div
                        key={index}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="rounded-3xl border border-white/10 bg-white/5 p-5 text-left backdrop-blur-sm transition duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:border-cyan-300/40 hover:bg-white/10 hover:shadow-[0_14px_40px_rgba(34,211,238,0.12)]"
                >
        ...
        <section id="services" className="py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mb-12">
              <span className="inline-flex rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.2em] text-cyan-200 transition duration-300 hover:scale-105 hover:bg-cyan-400/15">
                Why CampusSync
              </span>
              <h2 className="mt-4 text-3xl sm:text-4xl font-bold tracking-tight text-white transition duration-300 hover:text-cyan-200">
                Built for modern campus operations
              </h2>
              <p className="mt-4 text-base text-white/60 max-w-2xl transition duration-300 hover:text-white/80">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="rounded-[28px] border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:border-cyan-300/40 hover:bg-white/10 hover:shadow-[0_14px_40px_rgba(34,211,238,0.12)]"
                >
                  <feature.icon className="h-6 w-6 text-cyan-300 transition duration-300 hover:scale-110" />
                  <h3 className="mt-4 text-lg font-semibold text-white transition duration-300 hover:text-cyan-200">
                    {feature.title}
                  </h3>
                  <p className="mt-2 text-sm leading-7 text-white/60 transition duration-300 hover:text-white/80">
                    {feature.description}
                  </p>
                </div>
              ))}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {howItWorks.map((item) => (
                <div
                  key={item.step}
                  className="rounded-[28px] border border-white/10 bg-white/5 p-7 backdrop-blur-sm transition duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:border-cyan-300/40 hover:bg-white/10 hover:shadow-[0_14px_40px_rgba(34,211,238,0.12)]"
                >
                  ...
                  <h3 className="mt-5 text-lg font-semibold text-white transition duration-300 hover:text-cyan-200">
                    {item.title}
                  </h3>
                  <p className="mt-3 text-sm leading-7 text-white/60 transition duration-300 hover:text-white/80">
                    {item.description}
                  </p>
                </div>
              ))}
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-white transition duration-300 hover:text-cyan-200">
                        {testimonial.name}
                      </p>
                  ...
                  <p className="mt-5 text-sm leading-7 text-white/70 italic transition duration-300 hover:text-white/90">
                    “{testimonial.content}”
                  </p>
        ...
        <section id="contact" className="py-20">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-[34px] border border-cyan-400/15 bg-gradient-to-br from-cyan-400/10 via-white/5 to-white/0 px-6 py-14 text-center backdrop-blur-xl transition duration-300 hover:border-cyan-300/30 hover:shadow-[0_18px_50px_rgba(34,211,238,0.12)]">
              <span className="inline-flex rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.2em] text-white/70 transition duration-300 hover:scale-105">
                Start now
              </span>
              <h2 className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white transition duration-300 hover:text-cyan-200">
                Ready to launch better campus events?
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-base text-white/65 transition duration-300 hover:text-white/85">
